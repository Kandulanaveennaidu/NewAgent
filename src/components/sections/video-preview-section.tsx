    ...
    <div className="w-full max-w-4xl mx-auto rounded-xl shadow-2xl p-2 sm:p-3 bg-gradient-to-br from-neutral-800 to-neutral-900 relative">
      ...
      <div className="bg-neutral-950 aspect-[16/10] w-full overflow-hidden flex flex-col">
        ...
        <div className="bg-neutral-800/70 text-white p-1.5 sm:p-2 flex items-center justify-between border-b border-neutral-700/50 h-10 sm:h-12 flex-shrink-0">
          <div className="flex items-center gap-1 sm:gap-2">
            <Button
              variant="ghost"
              size="icon"
              className="text-neutral-300 hover:text-white h-7 w-7 sm:h-8 sm:w-8"
            >
              <ChevronLeft size={16} />
            </Button>
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="text-neutral-300 hover:text-white hover:bg-neutral-700 text-xs sm:text-sm h-7 sm:h-8 px-2 sm:px-3"
            >
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="w-12 sm:w-16 bg-neutral-800/50 p-1 sm:p-2 flex flex-col items-center space-y-3 sm:space-y-4 border-r border-neutral-700/50 flex-shrink-0">
            {[
              ...
              <Button
                ...
                variant="ghost"
                size="icon"
                className="text-neutral-400 hover:text-white hover:bg-neutral-700 w-10 h-9 sm:w-10 sm:h-10 flex flex-col"
                title={item.label}
              >
                <item.icon size={16} />
          ...
          {/* Video Preview Area - Enhanced for smaller devices */}
          <div className="flex-1 bg-black relative flex items-center justify-center p-0 sm:p-1 md:p-2 overflow-hidden">
            <video
              ...
              muted
              playsInline
              className="object-cover sm:object-contain w-full h-full min-h-[180px] rounded shadow-lg"
              style={{
        ...
        <div className="bg-neutral-800/70 text-white p-1.5 sm:p-2 border-t border-neutral-700/50 h-24 sm:h-28 flex-shrink-0 flex flex-col">
          <div className="flex items-center justify-between mb-1 h-7 sm:h-8">
            <Button
              variant="ghost"
              size="sm"
              className="text-[10px] sm:text-xs text-neutral-300 hover:text-white hover:bg-neutral-700 h-6 sm:h-7 px-1.5 sm:px-2"
            >
            ...
            <div className="flex items-center gap-0.5 sm:gap-1">
              <Button
                variant="ghost"
                size="icon"
                className="text-neutral-300 hover:text-white h-6 w-6 sm:h-7 sm:w-7"
              >
                <Rewind size={14} />
              </Button>
              <Button
                variant="ghost"
                size="icon"
                className="text-neutral-300 hover:text-white h-7 w-7 sm:h-8 sm:w-8 bg-neutral-700/50"
              >
                <Play size={16} />
              </Button>
              <Button
          ...
          <div className="flex-1 overflow-hidden relative pt-0.5 sm:pt-1">
            <div className="h-8 sm:h-10 bg-neutral-700/40 rounded flex items-center px-1 space-x-0.5">
              {Array.from({ length: 12 }).map((_, i) => (
                <div
                  key={i}
                  className={`h-6 sm:h-8 flex-1 rounded-sm ${
                    i === 3 || i === 4 ? "bg-cyan-500/70" : "bg-purple-500/40"
                  }`}
                ></div>
              ))}
            </div>
