  ...
  textLinkColumns: [
    {
      ...
      links: [
        { label: "TV News", href: "/products/solutions/tv-news" },
    ...
    },
    {
      ...
      links: [
        {
          label: "Web Avatar Chat Agent",
          href: "/products/solutions/web-avatar-chat",
        },
  ...
  },
  {
    ...
    dropdownSections: [
      ...
      },
      {
        ...
        items: [{ label: "Integrations", href: "#integrations", icon: "Cog" }],
      },
    ],
  },
                      ...
                      <div className="flex gap-x-8">
                        <div className="w-[300px] flex-shrink-0">
                          ...
                          <div className="space-y-3">
                            {link.productsMegaMenuData.coreFeatures.map(
                              (item) => (
                                <Link
                                  key={item.title}
                                  href={item.href}
                        ...
                        <div className="flex-1 space-y-6">
                          {link.productsMegaMenuData.columns.map(
                            (row, rowIndex) => (
                              <div
                                key={rowIndex}
                    ...
                    {link.solutionsMegaMenuData && (
                      <div className="flex gap-x-8">
                        <div className="grid grid-cols-2 gap-x-8">
                          {link.solutionsMegaMenuData.textLinkColumns.map(
                            (col) => (
                              <div key={col.title}>
                                <h3 className="mb-3 text-sm font-semibold text-foreground">
                                  {col.title}
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  "px-3 py-2 text-sm font-medium text-foreground/80 transition-colors hover:text-accent-foreground hover:bg-accent hover:no-underline active:scale-95"
                )}
              >
                {link.label}
              </Link>
                              ...
                              <nav className="flex flex-col space-y-1">
                                {link.productsMegaMenuData && (
                                  <>
                                    ...
                                    {link.productsMegaMenuData.columns
                                      .flat()
                                      .map((column) => (
